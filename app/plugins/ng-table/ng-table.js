...
var NgTableParams = (function () {
    function NgTableParams(baseParameters, baseSettings) {
        ...
        // run events during construction after the initial create eventAll. That way a consumer
        // can subscribe to all events for a table without "dropping" an eventAll
    ...
    NgTableParams.prototype.reload = function () {
        ...
        return pData.then(function (data) {
            ...
            _this.data = data;
            // note: I think it makes sense to publish this eventAll even when data === oldData
            // subscribers can always set a filter to only receive the eventAll when data !== oldData
